...
const page = () => {
  ...
  //         Array.isArray(result.forecast_dates) &&
  //         result?.forecasts
  //       ) {
  //         setArimaForecast({
  //           source: "arima", // to tag it later in ForecastCarousel
  //           coord: result.location || {},
  //           list: result.forecast_dates.map((date, i) => ({
  //             dt: Math.floor(new Date(date).getTime() / 1000),
  //             components: Object.fromEntries(
  //               Object.entries(result.forecasts).map(([key, arr]) => [
  //                 key,
  //                 arr[i],
  //               ])
  //             ),
    ...
    <div>
      ...
      <section className="centered-section aqi-forecast mt-15">
        ...
        <div className="graphs">
          <AQIForecastGraph forecastData={openWeatherForecast} arimaForecast={arimaForecast} />
        </div>
